...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setMainViewDelegate(controller: DeviceViewController){
        if(UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad){
    ...
    func setServiceViewDelegate(controller: ServiceViewController){
        if(UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad){
    ...
    func setCharViewDelegate(controller: CharViewController){
        if(UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad){
